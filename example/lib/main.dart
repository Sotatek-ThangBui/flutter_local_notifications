...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _showNotificationCustomSound() async {
    const AndroidNotificationDetails androidPlatformChannelSpecifics =
      ...
      sound: RawResourceAndroidNotificationSound('apex'),
    );
    const IOSNotificationDetails iOSPlatformChannelSpecifics =
        IOSNotificationDetails(sound: 'apex.mp3');
    const MacOSNotificationDetails macOSPlatformChannelSpecifics =
        MacOSNotificationDetails(sound: 'apex.mp3');
  ...
  Future<void> _zonedScheduleNotification() async {
    await flutterLocalNotificationsPlugin.zonedSchedule(
      ...
      const NotificationDetails(
        iOS: IOSNotificationDetails(sound: 'apex.mp3', presentSound: true),
        android: AndroidNotificationDetails(
          'your channel id',
          'your channel name',
          channelDescription: 'your channel description',
  ...
  Future<void> _repeatNotification() async {
    ...
    const NotificationDetails platformChannelSpecifics = NotificationDetails(
      android: androidPlatformChannelSpecifics,
      iOS: IOSNotificationDetails(sound: 'apex.mp3'),
    );
